 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Courses" type="{http://www.demosoap.com/courses}CourseDetails" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetAllCourseDetailsResponse", namespace = "http://www.demosoap.com/courses")
public class GetAllCourseDetailsResponse {

    @XmlElement(name = "Courses", namespace = "http://www.demosoap.com/courses", required = true)
    protected List<CourseDetails> courses;
